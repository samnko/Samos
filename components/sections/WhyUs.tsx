...
export default function WhyUs({ t }: { t: Dictionary["why"] }) {
  return (
    <section id="why" data-tone="dark" aria-labelledby="why-title" className="grain relative overflow-hidden bg-ink py-28 text-ivory md:py-40">
      <div aria-hidden="true" className="pointer-events-none absolute -end-40 -top-40 h-[36rem] w-[36rem] rounded-full bg-navy/40 blur-[120px]" />
      <div className="container-luxe relative grid gap-16 lg:grid-cols-12">
        ...
        <ol className="lg:col-span-6 lg:col-start-7">
          {t.items.map((item, i) => (
            ...
            >
              <span className="font-serif text-2xl italic text-accent transition-transform duration-700 group-hover:translate-x-1 rtl:group-hover:-translate-x-1" dir="ltr">
                0{i + 1}
              </span>
              <div>
